...
async function main() {
  ...
  params.append('query_date', '2026-08-20');
  params.append('end_date', '2026-08-20');
  ...
  for (const line of lines) {
    if (line.startsWith('2026-08-20')) count20++;
  }
  console.log(`TSV Lines: ${lines.length}. Lines starting with 2026-08-20: ${count20}`);
}
main();
