                            ...
                            <tr key={a.id} className="hover:bg-white/[0.02] transition-colors">
                              ...
                              <td className="py-3.5 px-4">
                                <div className="flex items-center justify-end gap-2">
                                  ...
                                  {a.status === 'accepted' && (
                                    <button onClick={() => navigate(`/dialer?phone=${encodeURIComponent(a.customer_phone)}&assignment_id=${a.call_lead_id}`)} className="flex items-center gap-1.5 px-4 py-1.5 bg-indigo-500 hover:bg-indigo-400 text-white rounded-lg text-[10px] font-bold uppercase tracking-widest transition-all shadow-[0_0_10px_rgba(99,102,241,0.2)]">
