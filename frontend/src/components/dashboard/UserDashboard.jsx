...
import {
  ...
  TrendingUp, BarChart2, Zap, Send, AlertCircle, Clock
} from 'lucide-react';
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              <select
                ...
                className="appearance-none w-36 sm:w-40 bg-slate-900/80 border border-slate-700/80 text-slate-200 text-[11px] sm:text-xs rounded-lg px-3 py-2 pr-8 hover:bg-slate-800 focus:outline-none focus:ring-1 focus:ring-violet-500/50 transition-all cursor-pointer shadow-sm font-medium"
              >
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
          {[
            ...
            { label: 'Assigned', value: stats?.dialerStats?.assigned ?? 0, icon: Send, bg: 'bg-violet-500/10', text: 'text-violet-400', border: 'border-violet-500/20' },
